...
export function NakamaManager() {
    ...
    const confirmRoom = useConfirmationDialog({
        ...
        description: "By continuing, you agree to broadcast your playback state through Tori's servers to sync with peers while the room is active. You are limited to 10 rooms per day and 4 peers per room (subject to change).",
        onConfirm: () => {
            handleCreateRoom()
        },
                                        ...
                                        <div className="flex items-center justify-between">
                                            <div className="space-y-1">
                                                ...
                                                <p className="text-sm text-[--muted] pr-4">
                                                    Cloud Rooms use Tori's API to enable hosting watch parties without exposing your server to the
                                                    internet.
                                                </p>
                                            </div>
                                            <Tooltip
