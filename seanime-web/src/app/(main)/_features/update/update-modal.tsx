            ...
            >
                ...
                <div className="space-y-2">
                    ...
                    {serverStatus?.isDesktopSidecar && <Alert
                        intent="info"
                        description="Update Tori from the desktop application."
                    />}
                    ...
                    <div className="flex gap-2 w-full items-center !mt-4">
                        {!serverStatus?.isDesktopSidecar && <Modal
                            ...
                            title={<span>Update Tori</span>}
                        >
                            <div className="space-y-4">
                                <p>
                                    Tori will perform an update by downloading and replacing existing files.
