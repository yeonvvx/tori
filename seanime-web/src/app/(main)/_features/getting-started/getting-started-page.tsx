        ...
        >
            <motion.div variants={itemVariants} className="text-center space-y-4">
                ...
                <p className="text-[--muted] text-sm max-w-lg mx-auto">
                    Choose the folder where your anime files are stored. This is where Tori will scan for your collection.
                </p>
            </motion.div>
        ...
        >
            <motion.div variants={itemVariants} className="text-center space-y-4">
                ...
                {__isElectronDesktop__ && <div className="max-w-3xl mx-auto p-4 rounded-xl border !mb-8 font-medium">
                    Tori Denshi includes a built-in media player that is enabled by default. You can still configure an external media player.
                </div>}
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        {defaultPlayer === "iina" && (
                            ...
                            >
                                ...
                                <Alert
                                    intent="info-basic"
                                    description={<p>For IINA to work correctly with Tori, make sure <strong>Quit after all windows are
