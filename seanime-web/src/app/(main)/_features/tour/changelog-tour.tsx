    ...
    const get3_5_0 = (): TourStep[] => {
        return [
            ...
            },
            {
                ...
                content: "Transcoding/Direct Play now uses the custom Tori player used by Tori Denshi and Online Streaming.",
                route: "/settings",
                prepare: async () => {
    ...
    const get3_7_0 = (): TourStep[] => {
        return [
            ...
            },
            {
                id: "changelog-2",
                title: "Bug Fixes",
                content: "Several bugs have been fixed in this release, including some related to Tori Denshi and plugins. Read the full changelog for more details.",
                route: "/",
                ignoreOutsideClick: true,
            },
        ]
    ...
    const get3_8_0 = (): TourStep[] => {
        return [
            ...
            },
            {
                ...
                content: "Choose which episode source Tori should open by default when you land on an anime page.",
                route: "/settings",
                prepare: async () => {
                    setSettingsTab("seanime")
            ...
            },
            {
                ...
                content: "Tori can now preload routes in the background to make navigation feel instant. You can adjust the preloading behavior in the new UI settings panel.",
                prepare: async () => {
            ...
            },
            {
                ...
                content: "Tori Denshi now remembers its window position and size, so reopening the app brings you back to the same desktop layout.",
                route: "/settings",
                prepare: async () => {
            ...
            //     content: "Tori Denshi now uses the View Transitions API for native transitions between different screens.",
            //     route: "/schedule",
            //     prepare: async () => {
            //         setSettingsTab("seanime")
    ...
    const get3_9_0 = (): TourStep[] => {
        return [
            ...
            },
            {
                id: "changelog-2",
                title: "Bug Fixes",
                content: "Several bugs have been fixed in this release, including progress tracking for MPV/IINA, manga image proxy issues, and Tori Denshi's Electron has been updated to 42.4.0. Read the full changelog for more details.",
                route: "/",
                ignoreOutsideClick: true,
            },
        ]
